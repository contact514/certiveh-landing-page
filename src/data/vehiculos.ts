...
export const vehiculos: Vehiculo[] = [
  ...
  },
  {
    ...
    precioFuente: "BYD Colombia (Motorysa),versión GS 2027",
    descripcion: "Hatchback eléctrico con batería Blade de BYD. Más espacio interior y equipamiento que el Dolphin Mini, manteniendo un formato urbano.",
  },
  {
    slug: "tesla-model-3",
    marca: "Tesla",
    ...
    precioFuente: "Tesla Motors Colombia,versión RWD",
    descripcion: "Sedán eléctrico de Tesla y referente del segmento. Versión RWD de acceso, con Autopilot de serie y acceso a la red de Superchargers.",
  },
  {
    slug: "tesla-model-y",
    marca: "Tesla",
    ...
    precioFuente: "Tesla Motors Colombia,versión RWD",
    descripcion: "SUV eléctrico mediano, uno de los más vendidos a nivel global. Versión RWD de acceso, con cinco plazas y acceso a la red de Superchargers.",
  },
  {
    ...
    precioFuente: "Hyundai Colombia (Astara),versión EV Limited",
    descripcion: "SUV subcompacto eléctrico de segunda generación, en su versión tope de gama EV Limited. Carga rápida en corriente directa y equipamiento completo.",
  },
];
