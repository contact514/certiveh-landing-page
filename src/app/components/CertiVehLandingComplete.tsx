...
function Servicios() {
  ...
  const servicios = [
    ...
    },
    {
      ...
      desc: "La DIAN concede una sola cita por contribuyente: si la pides tú, gastas el cupo y tu trámite se atasca. Leemos tu RUT, definimos si te toca cita o buzón electrónico, y la pedimos por ti. A ti te queda firmar y reenviar un correo (Concepto DIAN 673/2026).",
      price: "Desde $499.990",
