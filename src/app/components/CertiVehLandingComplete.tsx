...
function ComoFunciona() {
  ...
  const steps = [
    ...
    { num: "03", icon: "lock",        title: "Pago único",             subtitle: "Una sola vez",             desc: "Pagas nuestra tarifa de servicio una sola vez. Sin suscripciones, sin costos ocultos. El pago confirma tu caso y activa el proceso.", detail: "Paga con tu método favorito: tarjeta, PSE, Nequi o transferencia." },
...
function WinWin() {
  ...
  const steps = [
    ...
    { num: "03", icon: "dollarSign", title: "Gana $75.000 por cada uno", desc: "Cada vez que un amigo solicite su trámite, tú ganas $75.000 que puedes retirar cuando quieras." },
  ];
  return (
