...
function ComoFunciona() {
  ...
  const steps = [
    ...
    { num: "03", icon: "lock",        title: "Pago único",             subtitle: "Una sola vez",             desc: "Pagas nuestra tarifa de servicio una sola vez. Sin suscripciones, sin costos ocultos. El pago confirma tu caso y activa el proceso.", detail: "Paga seguro con tu método favorito: tarjeta, PSE o Nequi." },
