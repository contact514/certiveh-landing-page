...
function ComoFunciona() {
  ...
  const steps = [
    { num: "01", icon: "upload",      title: "Sube tus documentos",    subtitle: "Menos de 3 minutos",       desc: "Solo necesitas tu cédula, tarjeta de propiedad, factura de compra y RUT. La IA extrae los datos automáticamente.", detail: "Sin formularios manuales. Sin errores de digitación." },
