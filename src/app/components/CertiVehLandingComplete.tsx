...
function PorQueNoSolo() {
  const items = [
    ...
    },
    {
      ...
      problema: "El certificado debe reflejar el valor sin IVA. Registrar el total de la factura genera un dato incoherente con la DIAN que puede bloquear la aplicación de los beneficios.",
