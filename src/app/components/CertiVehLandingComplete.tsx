...
function PorQueNoSolo() {
  const items = [
    ...
    },
    {
      ...
      problema: "El certificado debe reflejar el valor antes de impuestos y descuentos. Registrar el total de la factura genera un dato incoherente con la DIAN que puede impedir la aplicación de los beneficios.",
